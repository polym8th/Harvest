...
| Leaving the Postcode field blank     |'Please enter postcode' - pop up message occurs when the field is left blank.              | Error message appears when the user tries to submit without input.              | ✅ PASS      |
