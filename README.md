...
| Shortcut to Article and Event        | Click on 'Article' or 'Event' shortcut from the creator dashboard - to view own articles. | User is navigated directly to the Article or Event list view.                   | ✅ PASS      |
